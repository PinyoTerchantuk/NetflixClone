    ...
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2"> 
                    <label htmlFor="email" className="text-sm font-medium text-gray-300 block"></label>
                    <input type="email" 
...
<div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-lg md:text-xl">Stream unlimited movies and TV shows on your phone, tablet, tablet, laptop, and TV.</p>
                </div>
                {/* right side */}
    ...
    <div className="py-10 bg-black text-white">
        ...
        <div className="flex-1 text-center md:text-left ">
               ...
               <p  className="text-lg md:text-xl">
                Send kids on adventures with their favorite charactors in a space made just for them-free with your membership.
               </p>
        </div>
    ...
    //Responsive จอเล็กลงตัวหนังสือก็ต้องใหญ่ขึ้นสิ
    //flex flex-col md:flex-row เกิน768px มันจะเป็นFlex row ถ้าไม่เกินจะเป็นColumn
    //เมื่อกำหนก Flex มาเเล้วไม่ว่าที่ไหนก็ตาม พอกำหนดFlexมันจะโดนเเบ่ง side by sideทันที0
    //relative: ทำให้ div นี้เป็นจุดอ้างอิง (reference point) สำหรับลูกที่ใช้ตำแหน่งแบบ absolute
    //absolute top-1/2 left-1/2 ยึดจุดจากเเม่ที่เป็นre;ative เเล้วทำให้คลิปตัวเองอยู่ตรงกึ้งกลางเเม่
    //absolute top-1/2 left-1/2    ยึดจุดเเม่ ยึดเเม่เเล้วตำเเหน่งเราอยู่ที่ครึ่งนึงของซ้ายบนของเเม่
    //-translate-x-1/2 -translate-y-1/2  ให้ตัวเองเป็นครึ่งนึงของตัวเอง
